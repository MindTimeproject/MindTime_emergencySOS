...
public class RegisterPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        b2.setOnClickListener( new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                DeleteData(x);
                Toast.makeText(RegisterPage.this,"Data Deleted",Toast.LENGTH_SHORT ).show();
            }
        });
    ...
    private void loadData() {
        ...
        if (data.getCount()==0){
            Toast.makeText(RegisterPage.this, "There is no content",Toast.LENGTH_SHORT ).show();
        }
    ...
    private boolean DeleteData(String x) {
        return sqlitedb.delete( DatabseHandler.TABLE_NAME, DatabseHandler.COL2 + "=?", new String[]{x})>0;
    }
    ...
    private void addData(String newEntry) {
        ...
        if (insertData==true){
            ...
            Toast.makeText(RegisterPage.this, "Unsuccessfull",Toast.LENGTH_SHORT).show();
        }
    }
